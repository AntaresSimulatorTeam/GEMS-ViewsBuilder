...
from gems_views_builder.aggregators.transformations_patterns_processor import TransformationsPatternsProcessor
...
def build_metric_views(raw_input_data: RawInputData) -> list[TemporalMetricView]:
    ...
    transformations_patterns_processor = TransformationsPatternsProcessor(view_building_input.view_config)
    return ViewBuilder(view_building_input, metric_structure_table_builder, transformations_patterns_processor).build()
