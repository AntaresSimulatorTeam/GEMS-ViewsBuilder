...
from gems_views_builder.input.component import find_components_taxonomy_categories
from gems_views_builder.input.component import Component, group_components_by_taxonomy_category, build_component_port_connections, save_component_port_connections
...
def run(input_dir: Path, results_dir: Path) -> None:
    ...
    metric_structure_table_builder = MetricStructureTableBuilder(
        input_data.system, input_data.library, input_data.view_config.location_taxonomy_category, components_by_taxonomy_category
    )
