...
# The intention of this class is to record a MetricView generated by the TimeAggregator
# in a dictionary, for any further possible reuse.
class TimeAggregatorDecorator: # Should inherit from base common class
    ...
    def run(self, metric_view: TemporalMetricView, metric: Metric) -> MetricView:
        if self.time_granularity not in self.time_aggregated_metric_views:
            new_metric_view = self.time_aggregator.run(metric_view, metric)
            self.time_aggregated_metric_views[self.time_granularity] = new_metric_view
            return new_metric_view
